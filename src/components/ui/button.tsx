  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        ocean: "bg-gradient-to-r from-turquoise to-turquoise-glow text-primary-foreground shadow-lg hover:shadow-[0_4px_20px_hsl(180_70%_45%_/_0.5)] hover:scale-105 active:scale-95",
        gold: "bg-gradient-to-r from-accent to-sand text-primary-foreground shadow-lg hover:shadow-[0_4px_20px_hsl(45_80%_60%_/_0.5)] hover:scale-105 active:scale-95",
        glass: "bg-white/10 backdrop-blur-md border border-white/20 text-foreground hover:bg-white/20 hover:scale-105",
      },
      size: {
